...
RPC_ENDPOINT = http://localhost:7545 # for ganache network
PRIVATE_KEY = 02b39cac1532bef9dba3e36ec32d3de1e9a88f1dda597d3ac6e2130aed9adc4e #you can use this value for ganache network
```
