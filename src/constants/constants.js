...
export const OPERATION_ID_STATUS = {
    ...
    FIND_NODES_GET_MIN_ACK_RESPONSES_START: 'FIND_NODES_GET_MIN_ACK_RESPONSES_START',
    FIND_NODES_GET_MIN_ACK_RESPONSES_END: 'FIND_NODES_GET_MIN_ACK_RESPONSES_END',
    ...
    NETWORK_PROTOCOL_GET_MIN_ACK_RESPONSE_START: 'NETWORK_PROTOCOL_GET_MIN_ACK_RESPONSE_START',
    NETWORK_PROTOCOL_GET_MIN_ACK_RESPONSE_END: 'NETWORK_PROTOCOL_GET_MIN_ACK_RESPONSE_END',
    ...
    PUBLISH: {
        ...
        PUBLISH_FIND_NODES_GET_MIN_ACK_RESPONSES_START:
            'PUBLISH_FIND_NODES_GET_MIN_ACK_RESPONSES_START',
        PUBLISH_FIND_NODES_GET_MIN_ACK_RESPONSES_END:
            'PUBLISH_FIND_NODES_GET_MIN_ACK_RESPONSES_END',
        ...
        PUBLISH_NETWORK_GET_MIN_ACK_RESPONSE_START: 'PUBLISH_NETWORK_GET_MIN_ACK_RESPONSE_START',
        PUBLISH_NETWORK_GET_MIN_ACK_RESPONSE_END: 'PUBLISH_NETWORK_GET_MIN_ACK_RESPONSE_END',
    ...
    GET: {
        ...
        GET_FIND_NODES_GET_MIN_ACK_RESPONSES_START: 'GET_FIND_NODES_GET_MIN_ACK_RESPONSES_START',
        GET_FIND_NODES_GET_MIN_ACK_RESPONSES_END: 'GET_FIND_NODES_GET_MIN_ACK_RESPONSES_END',
        ...
        GET_NETWORK_GET_MIN_ACK_RESPONSE_START: 'GET_NETWORK_GET_MIN_ACK_RESPONSE_START',
        GET_NETWORK_GET_MIN_ACK_RESPONSE_END: 'GET_NETWORK_GET_MIN_ACK_RESPONSE_END',
        ...
        GET_LOCAL_GET_KA_METADATA_START: 'GET_LOCAL_GET_KA_METADATA_START',
        GET_LOCAL_GET_KA_METADATA_END: 'GET_LOCAL_GET_KA_METADATA_END',
        ...
        GET_REQUEST_SHOULD_SEND_MESSAGE_START: 'GET_REQUEST_SHOULD_SEND_MESSAGE_START',
        GET_REQUEST_SHOULD_SEND_MESSAGE_END: 'GET_REQUEST_SHOULD_SEND_MESSAGE_END',
        ...
        GET_REMOTE_GET_KA_METADATA_START: 'GET_REMOTE_GET_KA_METADATA_START',
        GET_REMOTE_GET_KA_METADATA_END: 'GET_REMOTE_GET_KA_METADATA_END',
    ...
    QUERY: {
        ...
        QUERY_END: 'QUERY_END',
        QUERY_VALIDATE_REPOSITORY_NAME_START: 'QUERY_VALIDATE_REPOSITORY_NAME_START',
        QUERY_VALIDATE_REPOSITORY_NAME_END: 'QUERY_VALIDATE_REPOSITORY_NAME_END',
        QUERY_PROCESS_FEDERATED_QUERY_REPO_START: 'QUERY_PROCESS_FEDERATED_QUERY_REPO_START',
        QUERY_PROCESS_FEDERATED_QUERY_REPO_END: 'QUERY_PROCESS_FEDERATED_QUERY_REPO_END',
        QUERY_PROCESS_QUERY_TYPE_START: 'QUERY_PROCESS_QUERY_TYPE_START',
        QUERY_PROCESS_QUERY_TYPE_END: 'QUERY_PROCESS_QUERY_TYPE_END',
    },
    LOCAL_STORE: {
