...
exports.HANDLER_ID_STATUS = {
    ...
    PUBLISH: {
        ...
        PUBLISH_GENERATE_METADATA_STOP: 'PUBLISH_GENERATE_METADATA_STOP',
    ...
    RESOLVE: {
        GETTING_LATEST_ASSERTION_ID: 'GETTING_LATEST_ASSERTION_ID',
        LOCAL_RESOLVE_ASSERTION: 'LOCAL_RESOLVE_ASSERTION',
        ...
        RESOLVE_LOCAL_START: '',
        RESOLVE_LOCAL_END: '',
        RESOLVE_FETCH_FROM_NODES_START: '',
        RESOLVE_FETCH_FROM_NODES_END: '',
