...
export const ERROR_TYPE = {
    ...
    UPDATE: {
        ...
        UPDATE_VALIDATE_ASSERTION_ERROR: 'UpdateValidateAssertionError',
...
export const OPERATION_ID_STATUS = {
    ...
    PUBLISH: {
        VALIDATING_PUBLISH_ASSERTION_START: 'VALIDATING_PUBLISH_ASSERTION_START',
        VALIDATING_PUBLISH_ASSERTION_END: 'VALIDATING_PUBLISH_ASSERTION_END',
    ...
    UPDATE: {
        ...
        VALIDATING_UPDATE_ASSERTION_START: 'VALIDATING_UPDATE_ASSERTION_START',
        VALIDATING_UPDATE_ASSERTION_END: 'VALIDATING_UPDATE_ASSERTION_END',
    ...
    LOCAL_STORE: {
        ...
        VALIDATING_LOCAL_STORE_ASSERTION_START: 'VALIDATING_LOCAL_STORE_ASSERTION_START',
        VALIDATING_LOCAL_STORE_ASSERTION_END: 'VALIDATING_LOCAL_STORE_ASSERTION_END',
    },
};
