...
export const OPERATION_ID_STATUS = {
    ...
    PUBLISH: {
        ...
        PUBLISH_VALIDATE_ASSET_GET_CACHED_OPERATION_ID_DATA_START:
            'PUBLISH_VALIDATE_ASSET_GET_CACHED_OPERATION_ID_DATA_START',
        PUBLISH_VALIDATE_ASSET_GET_CACHED_OPERATION_ID_DATA_END:
            'PUBLISH_VALIDATE_ASSET_GET_CACHED_OPERATION_ID_DATA_END',
        ...
        PUBLISH_REQUEST_GET_CACHED_OPERATION_ID_DATA_START:
            'PUBLISH_REQUEST_GET_CACHED_OPERATION_ID_DATA_START',
        PUBLISH_REQUEST_GET_CACHED_OPERATION_ID_DATA_END:
            'PUBLISH_REQUEST_GET_CACHED_OPERATION_ID_DATA_END',
        ...
        PUBLISH_LOCAL_STORE_REMOTE_GET_CACHED_OPERATION_ID_DATA_START:
            'PUBLISH_LOCAL_STORE_REMOTE_GET_CACHED_OPERATION_ID_DATA_START',
        PUBLISH_LOCAL_STORE_REMOTE_GET_CACHED_OPERATION_ID_DATA_END:
            'PUBLISH_LOCAL_STORE_REMOTE_GET_CACHED_OPERATION_ID_DATA_END',
    },
