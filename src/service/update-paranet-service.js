...
class UpdateParanetService extends OperationService {
    constructor(ctx) {
        super(ctx);

        this.operationName = OPERATIONS.UPDATE_PARANET;
        this.networkProtocols = NETWORK_PROTOCOLS.UPDATE_PARANET;
        this.errorType = ERROR_TYPE.UPDATE_PARANET.UPDATE_PARANET_ERROR;
        this.completedStatuses = [
            OPERATION_ID_STATUS.UPDATE_PARANET.UPDATE_PARANET_REPLICATE_END,
            OPERATION_ID_STATUS.UPDATE_PARANET.UPDATE_PARANET_END,
...
export default UpdateParanetService;
