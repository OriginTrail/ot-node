...
class ValidatePublishAssertionCommand extends Command {
    constructor(ctx) {
        super(ctx);
    ...
    /**
     * Builds default validatePublishAssertionCommand
     * @param map
     * @returns {{add, data: *, delay: *, deadline: *}}
     */
    default(map) {
        const command = {
            name: 'validatePublishAssertionCommand',
            delay: 0,
            transactional: false,
        };
...
export default ValidatePublishAssertionCommand;
