...
class HandleUpdateParanetRequestCommand extends HandleProtocolMessageCommand {
    constructor(ctx) {
        super(ctx);
        ...
        this.errorType = ERROR_TYPE.UPDATE_PARANET.UPDATE_PARANET_LOCAL_STORE_REMOTE_ERROR;
    }
    ...
    async prepareMessage(commandData) {
        ...
        await this.operationIdService.updateOperationIdStatus(
            operationId,
            blockchain,
            OPERATION_ID_STATUS.UPDATE_PARANET.VALIDATING_UPDATE_PARANET_ASSERTION_REMOTE_START,
        );
        ...
        await this.operationIdService.updateOperationIdStatus(
            operationId,
            blockchain,
            OPERATION_ID_STATUS.UPDATE_PARANET.VALIDATING_UPDATE_PARANET_ASSERTION_REMOTE_END,
        );
    ...
    /**
     * Builds default HandleUpdateParanetRequestCommand
     * @param map
     * @returns {{add, data: *, delay: *, deadline: *}}
     */
    default(map) {
        const command = {
            name: 'v1_0_0HandleUpdateParanetRequestCommand',
            delay: 0,
            transactional: false,
        };
...
export default HandleUpdateParanetRequestCommand;
