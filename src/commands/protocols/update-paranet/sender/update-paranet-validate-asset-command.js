...
class UpdateParanetValidateAssetCommand extends ValidateAssetCommand {
    constructor(ctx) {
        super(ctx);
    ...
    /**
     * Builds default updateParanetValidateAssetCommand
     * @param map
     * @returns {{add, data: *, delay: *, deadline: *}}
     */
    default(map) {
        const command = {
            name: 'updateParanetValidateAssetCommand',
            delay: 0,
            transactional: false,
        };
...
export default UpdateParanetValidateAssetCommand;
