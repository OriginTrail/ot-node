...
class SubmitUpdateCommitCommand extends SendTransactionCommand {
    constructor(ctx) {
        ...
        this.TX_START = OPERATION_ID_STATUS.COMMIT_PROOF.SUBMIT_UPDATE_COMMIT_SEND_TX_START;
        this.TX_END = OPERATION_ID_STATUS.COMMIT_PROOF.SUBMIT_UPDATE_COMMIT_SEND_TX_END;
        this.TX_ERROR = ERROR_TYPE.COMMIT_PROOF.SUBMIT_UPDATE_COMMIT_SEND_TX_ERROR;
        this.TX_GAS_INCREASE_FACTOR = COMMAND_TX_GAS_INCREASE_FACTORS.SUBMIT_UPDATE_COMMIT;
        this.END_STATUS = OPERATION_ID_STATUS.COMMIT_PROOF.SUBMIT_UPDATE_COMMIT_END;
        this.RETRY_NUMBER = COMMAND_RETRIES.SUBMIT_UPDATE_COMMIT;
    }
