...
const ABIs = {
    ...
    Staking: require('dkg-evm-module/abi/StakingV2.json'),
    ...
    Hub: require('dkg-evm-module/abi/HubV2.json'),
    IdentityStorage: require('dkg-evm-module/abi/IdentityStorageV2.json'),
    ...
    ScoringProxy: require('dkg-evm-module/abi/ProximityScoringProxy.json'),
