...
module.exports = (deployer, network, accounts) => {
    ...
    deployer.deploy(TracToken, accounts[0], accounts[1], accounts[2]).then(() =>
        giveMeTracToken()).then(result => deployer.deploy(EscrowHolder, result.address));
};
