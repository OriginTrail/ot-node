...
/**
 * @constant {object} SERVICE_API_ERROR -
 *  Service API error types
 */
exports.SERVICE_API_ERROR = {
    GET_NODE_INFO_ERROR: 'GET_NODE_INFO_ERROR',
    HANDLER_ID_NOT_FOUND: 'HANDLER_ID_NOT_FOUND',
    INVALID_ASSERTION_SEARCH_PARAMETER_VALUES: 'INVALID_ASSERTION_SEARCH_PARAMETER_VALUES',
    INVALID_ENTITY_SEARCH_PARAMETER_VALUES: 'INVALID_ENTITY_SEARCH_PARAMETER_VALUES',
    INVALID_PUBLISH_PARAMETER_VALUES: 'INVALID_PUBLISH_PARAMETER_VALUES',
    INVALID_PROOFS_PARAMETER_VALUES: 'INVALID_PROOFS_PARAMETER_VALUES',
    INVALID_RESOLVE_PARAMETER_VALUES: 'INVALID_RESOLVE_PARAMETER_VALUES',
    INVALID_RESULT_OPERATION: 'INVALID_RESULT_OPERATION',
    INVALID_QUERY_PARAMETER_VALUES: 'INVALID_QUERY_PARAMETER_VALUES',
    INVALID_QUERY_TYPE: 'INVALID_QUERY_TYPE',
    INVALID_UUID_FORMAT: 'INVALID_UUID_FORMAT',
    UNEXPECTED_GET_RESULT_ERROR: 'UNEXPECTED_GET_RESULT_ERROR',
    UPDATE_FAILED_HANDLER_ID_ERROR: 'UPDATE_FAILED_HANDLER_ID_ERROR',
};
