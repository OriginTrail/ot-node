...
contract Hub is Ownable{
    ...
    address public replacementAddress;
    ...
    function setReplacementAddress(address newReplacementAddress)
    public onlyOwner {
        replacementAddress = newReplacementAddress;
        emit ContractsChanged();
    }
