...
let hour = 1520361602 + (60 * 60);
//console.log(encryptedVertices.vertices);
testing.generateTests('192.168.0.10', '8999', '0xE1E9c5379C5df627a8De3a951fA493028394A050', encryptedVertices.vertices, 10, 1520361602, hour, (res, err) => {
  //console.log(res);
});