...
describe('Operation service test', async () => {
    ...
    it('Tries to validate assertion but fails due to triple number mismatch', async () => {
        publishService.blockchainModuleManager.getAssertionTriplesNumber = (
            blockchain,
            assertionId,
    ...
    it('Tries to validate assertion but fails due to chunk size mismatch', async () => {
        publishService.blockchainModuleManager.getAssertionChunksNumber = (
            blockchain,
            assertionId,
