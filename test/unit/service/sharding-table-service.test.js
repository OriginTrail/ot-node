...
import { BID_SUGGESTION_OPTIONS, BYTES_IN_KILOBYTE } from '../../../src/constants/constants.js';
...
describe('Sharding table service test', async () => {
    ...
    it('Get bid suggestion, option low, returns bid suggestion successfully', async () => {
        const epochsNumber = 5;
        const assertionSize = BYTES_IN_KILOBYTE;
        const contentAssetStorageAddress = '0xABd59A9aa71847F499d624c492d3903dA953d67a';
        const firstAssertionId =
        ...
        const bidSuggestions = await shardingTableService.getBidSuggestion(
            ...
            firstAssertionId,
            hashFunctionId,
            BID_SUGGESTION_OPTIONS.LOW,
        );
        expect(bidSuggestions).to.be.equal('3159263771965710000');
    });

    it('Get bid suggestion, option medium, returns bid suggestion successfully', async () => {
        const epochsNumber = 5;
        const assertionSize = BYTES_IN_KILOBYTE;
        const contentAssetStorageAddress = '0xABd59A9aa71847F499d624c492d3903dA953d67a';
        const firstAssertionId =
        ...
        const bidSuggestions = await shardingTableService.getBidSuggestion(
            ...
            firstAssertionId,
            hashFunctionId,
            BID_SUGGESTION_OPTIONS.MEDIUM,
        );
        expect(bidSuggestions).to.be.equal('3788323225298705400');
    });

    it('Get bid suggestion, option high, returns bid suggestion successfully', async () => {
        const epochsNumber = 5;
        const assertionSize = BYTES_IN_KILOBYTE;
        const contentAssetStorageAddress = '0xABd59A9aa71847F499d624c492d3903dA953d67a';
        const firstAssertionId =
        ...
        const bidSuggestions = await shardingTableService.getBidSuggestion(
            ...
            firstAssertionId,
            hashFunctionId,
            BID_SUGGESTION_OPTIONS.HIGH,
        );
        expect(bidSuggestions).to.be.equal('14756236785320528700');
    });

    it('Get bid suggestion, default option, returns bid suggestion successfully', async () => {
        const epochsNumber = 5;
        const assertionSize = BYTES_IN_KILOBYTE;
        const contentAssetStorageAddress = '0xABd59A9aa71847F499d624c492d3903dA953d67a';
        const firstAssertionId =
