...
#
#  @skip: Whitelisted viewer should receive the complete dataset after query
#  Given the replication difficulty is 0
#  And I setup 3 nodes
#  And I start the nodes
#  And I use 1st node as DC
#  And DC imports "importers/use_cases/marketplace/marketplace_use_case.json" as OT-JSON
#  And DC waits for import to finish
#  Given DC initiates the replication for last imported dataset
#  And DC waits for replication window to close
#  And DC whitelists DV
#  Given I additionally setup 1 node
#  And I start additional node
#  And I use 4th node as DV
#  Given DV publishes query consisting of path: "identifiers.id", value: "urn:ot:object:actor:id:OneAgrix" and opcode: "EQ" to the network
