...
cp origintrail_noderc.image $ARTIFACTS_DIR/origintrail_noderc.image
docker run -d --name=mynode -p 8900:8900 -p 5278:5278 -p 3000:3000 --network host -v $ARTIFACTS_DIR/origintrail_noderc.image:/ot-node/.origintrail_noderc myimage:latest
